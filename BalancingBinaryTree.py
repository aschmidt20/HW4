...
"""
A balanced binary tree implementation we use for the last two parts of the homework found at
https://github.com/marehr/binary-tree/blob/master/binary_tree.py
"""
class NodeKey():
